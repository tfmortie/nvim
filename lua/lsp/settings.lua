...
local function lsp_keymaps(bufnr)
  ...
  vim.api.nvim_buf_set_keymap(bufnr,"n","gc",'<cmd>lua vim.diagnostic.open_float()<CR>',opts)
  vim.api.nvim_buf_set_keymap(bufnr, "n", "]c", '<cmd>lua vim.diagnostic.goto_next({ border = "rounded" })<CR>', opts)
  vim.api.nvim_buf_set_keymap(bufnr, "n", "gC", "<cmd>lua vim.diagnostic.setloclist()<CR>", opts)
